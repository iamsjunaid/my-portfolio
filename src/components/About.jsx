            ...
            <div className="flex justify-between items-center py-2">
              ...
              <span>
                {languagesButtonClicked
                  ? <HiChevronDown onClick={handleShowLanguages} className="text-2xl hover:cursor-pointer" />
                  : <HiChevronRight onClick={handleShowLanguages} className="text-2xl hover:cursor-pointer" />}
              </span>
            </div>
            <div className={`flex gap-4 ${showLanguages === true ? 'flex-row' : 'hidden'}`}>
            ...
            <div className="flex justify-between items-center py-2">
              ...
              <span>
                {FramworksButtonClicked
                  ? <HiChevronDown onClick={handleShowFramworks} className="text-2xl hover:cursor-pointer" />
                  : <HiChevronRight onClick={handleShowFramworks} className="text-2xl hover:cursor-pointer" />}
              </span>
            </div>
            <div className={`flex gap-4 ${showFrameworks === true ? 'flex-row' : 'hidden'}`}>
              <div className="h-[80px] w-[80px] bg-[#f4f5f7] rounded-[50%] inline-block flex justify-center items-center">
              ...
              <div className="h-[80px] w-[80px] bg-[#f4f5f7] rounded-[50%] inline-block flex justify-center items-center">
                <img src={ror} alt="ruby-on-rails" className="w-[62px] h-[62px]" />
              </div>
            </div>
          </li>
          <li className="border-b-2">
            <div className="flex justify-between items-center py-2">
              ...
              <span>
                {databasesButtonClicked
                  ? <HiChevronDown onClick={handleShowDatabases} className="text-2xl hover:cursor-pointer" />
                  : <HiChevronRight onClick={handleShowDatabases} className="text-2xl hover:cursor-pointer" />}
              </span>
            </div>
            <div className={`flex gap-4 ${showDatabases === true ? 'flex-row' : 'hidden'}`}>
              <div className="h-[80px] w-[80px] bg-[#f4f5f7] rounded-[50%] inline-block flex justify-center items-center">
                <img src={postgres} alt="postgres" className="w-[62px] h-[62px]" />
              </div>
              <div className="h-[80px] w-[80px] bg-[#f4f5f7] rounded-[50%] inline-block flex justify-center items-center">
