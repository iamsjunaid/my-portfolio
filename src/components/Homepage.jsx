...
const Homepage = () => (
  <section
    id="home"
    className="bg-home-bg-mobile bg-white bg-no-repeat bg-contain flex flex-col items-center sm:items-start justify-center px-8 sm:p-48  sm:bg-home-bg-desktop md:w-full md:bg-contain md:bg-no-repeat rounded-bl-[100px] bg-center h-screen"
  >
    <div className="gap-4 flex flex-col">
      ...
      <p className="text-primary font-normal text-base leading-6">
        ...
        Science Engineering.
        <br />
        Passionate about crafting dynamic and responsive web applications. With
        expertise in React, Next.js, and Ruby on Rails,
        <br />
        I bring ideas to life from concept to deployment. Let&apos;s
        collaborate to turn your vision into a digital reality!
      </p>
      ...
      <div className="text-quaternary flex gap-2">
        <a
          href="https://twitter.com/junaidahmedsd"
          aria-label="Twitter"
          target="_blank"
          rel="noreferrer"
        >
        ...
        <a
          href="mailto:sjunaid626@gmail.com"
          aria-label="Mail"
          target="_blank"
          rel="noreferrer"
        >
        ...
        <a
          href="https://github.com/iamsjunaid"
          aria-label="GitHub"
          target="_blank"
          rel="noreferrer"
        >
