...
const Homepage = () => (
  <section id="home" className="bg-home-bg-mobile bg-white bg-no-repeat bg-contain flex flex-col items-center sm:items-start justify-center px-8 sm:p-48  sm:bg-home-bg-desktop md:w-full md:bg-contain md:bg-no-repeat rounded-bl-[100px] bg-center h-screen">
