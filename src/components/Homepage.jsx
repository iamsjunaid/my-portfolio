...
const Homepage = () => (
  <section className="bg-home-bg-mobile bg-white bg-no-repeat bg-cover flex flex-col px-8 py-32 sm:px-4 sm:py-16  sm:bg-home-bg-desktop md:w-full md:bg-contain md:bg-no-repeat rounded-bl-[100px] bg-center">
