  ...
  return (
    ...
    >
      <div className="w-full flex flex-col items-center justify-center relative  backdrop-blur-sm hover:backdrop-blur-lg container">
        ...
        />
        <div className="absolute top-2 right-2 text-center hover:bg-white hover:text-secondary hover:border-secondary border-2 rounded-xl p-2 text-white items-center transition duration-500 ease-in-out see-live">
          <a
            href={project.live}
            target="_blank"
            rel="noreferrer"
